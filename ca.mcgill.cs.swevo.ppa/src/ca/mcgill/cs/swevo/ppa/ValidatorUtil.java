...
public class ValidatorUtil {
	public static boolean validateNull(Object input, String name, boolean throwException) {
	...
	public static boolean validateEmpty(String input, String name, boolean throwException) {
