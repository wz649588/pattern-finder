...
public class DotUtil {
  ...
  protected static DotOutputType outputType = DotOutputType.PDF;
   ...
   */
  protected final static int MAX_LABEL_LENGTH = Integer.MAX_VALUE;
  ...
  protected static String getRankDir() throws WalaException {
    return null;
  }
