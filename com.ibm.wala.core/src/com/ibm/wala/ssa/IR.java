...
public abstract class IR {
  ...
  public void removeNullInstructions() {
    // TODO Auto-generated method stub
      ArrayList<SSAInstruction> inslist = new ArrayList<SSAInstruction>();
      for(SSAInstruction ins:instructions){
        if(ins!=null){
          inslist.add(ins);
        }
      }
      instructions = new SSAInstruction[inslist.size()];
      for(int i=0; i< inslist.size(); i++){
         instructions[i] = inslist.get(i);
      }
  };
}
