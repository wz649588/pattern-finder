...
public class ClassDistiller {
    ...
    // Modified by Ye Wang, since 10/14/2016
    // process null left node or null right node
//    /**
//     * Extract the {@link SourceCodeChange}s of the {@link StructureDiffNode} with which the class distiller was
//     * initialized.
//     */
//    public void extractChanges() {
//    	ASTHelper<StructureNode> helper;
//    	StructureNode childNode;
//    	if (fClassDiffNode.getLeft() != null) {
//    		helper = fLeftASTHelper;
//    		childNode = fClassDiffNode.getLeft();
//    	} else {
//    		helper = fRightASTHelper;
//    		childNode = fClassDiffNode.getRight();
//    	}
//    	
//        fParentEntity = helper.createSourceCodeEntity(childNode);
//        if (fVersion != null) {
//        	fRootEntity = helper.createStructureEntityVersion(childNode, fVersion);
//        } else {
//        	fRootEntity = helper.createStructureEntityVersion(childNode);
//        }
//        processDeclarationChanges(fClassDiffNode, fRootEntity);
//        fChanges.addAll(fRootEntity.getSourceCodeChanges());
//        processChildren();
...
//            fChanges.addAll(entity.getSourceCodeChanges());
    ...
    private void processBodyChanges(StructureDiffNode diffNode, StructureEntityVersion rootEntity) {
        ...
        // Ye Wang, 06/08/2017
        Node leftRoot = fLeftASTHelper.createMethodBodyTree(diffNode.getLeft());
        Node rightRoot = fRightASTHelper.createMethodBodyTree(diffNode.getRight());
        if (leftRoot != null && rightRoot != null) {
	        HashSet<NodePair> treeMatches = TreeDifferencer.getTreeMatches(leftRoot, rightRoot);
	        TreeMatchRecorder.recorder.addMatch(leftRoot.getEntity(), rightRoot.getEntity(), treeMatches);
        }
        // END
    }
