...
public class FileDistiller {
    ...
    public void extractClassifiedSourceCodeChanges(File left, String leftVersion, File right, String rightVersion) {
    	...
    	if (left != null)
    		...
    		fLeftASTHelper = null;
    		// modified by Ye Wang to create ASTHelper for non-existing file
    		// 
//    		try {
...
//    		}
//    		fLeftASTHelper = fASTHelperFactory.create(emptyFile, leftVersion);
    	}
    	if (right != null)
...
//    			System.out.println(e.getMessage());
//    		}
//    		fRightASTHelper = fASTHelperFactory.create(emptyFile, rightVersion);
    	}
    ...
    private boolean mayHaveChanges(StructureNode left, StructureNode right) {
    	...
    	// process file addition or deletion
    	// return (left != null) || (right != null);
    }
    ...
    public static void main(String[] args) {
    	// File left = new File("/Users/nm8247/Documents/experiment_data/zhonghao/derby/derby/53822_DERBY-30/from/EmbedConnection.java");
    	// File right = new File("/Users/nm8247/Documents/experiment_data/zhonghao/derby/derby/53822_DERBY-30/to/EmbedConnection.java");
    	File left = new File("res/MyClass.java_v1");
		File right = new File("res/MyClass.java_v2");
    	FileDistiller distiller = ChangeDistiller.createFileDistiller();
    	FileDistiller.setIgnoreComments();
    	try{
    		distiller.extractClassifiedSourceCodeChanges(left, right);
    	} catch(Exception e) {
    		System.err.println("Warning: error while change dsitilling. ");
    		e.printStackTrace();
    	}
