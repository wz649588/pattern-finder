...
import edu.vt.cs.append.HungarianGraphComparator;
...
public final class MatchingFactory {
    ...
    //added by nameng
    public static TreeMatcher getMatcher2(Set<NodePair> matchingSet) {
    	StringSimilarityCalculator leafCalc = new NGramsCalculator(2);
        double lTh = 0.6;
...
//    	HungarianGraphComparator comparator = new HungarianGraphComparator();
        EnhancedBestLeafMatchDifferencer comparator = new EnhancedBestLeafMatchDifferencer();
    	comparator.init(leafCalc, lTh, nodeStringCalc, nStTh, nodeCalc, nTh);
    	comparator.setMatchingSet(matchingSet);
    	return comparator;
    }
}
