...
import static ch.uzh.ifi.seal.changedistiller.model.classifiers.java.JavaEntityType.COMPILATION_UNIT;//added by nameng
...
public final class JavaASTNodeTypeConverter implements ASTNodeTypeConverter {
    ...
    static {
        ...
        sConversionMap.put(CompilationUnitDeclaration.class, COMPILATION_UNIT);
    }
    ...
    // added by nameng
    public static EntityType convert(Class<?> klass) {
    	return sConversionMap.get(klass);
    }
}
