...
public class Term {
	...
	public static enum TermType {
		Term, MethodNameTerm, TypeNameTerm, VariableTypeBindingTerm
	};
	...
	public static Pattern AbsPattern = Pattern
			.compile(".+(v|m|t)\\$_[0-9]+_.*|.*(v|m|t)\\$_[0-9]+_.+|.+u\\$_[0-9]+_([a-zA-Z]+_).*|.*u\\$_[0-9]+_([a-zA-Z]+_)+.+");
	...
	public static List<String> InfixOperators = Arrays.asList(new String[] {
			"*", "/", "%", "+", "-", "<<", ">>", ">>>", "<", ">", "<=", ">=",
			"==", "!=", "^", "&", "|", "&&", "||", "+=", "-=", "*=", "/=",
			"%=", "=" });
	public static List<String> PrefixOperators = Arrays.asList(new String[] {
			"++", "--", "+", "-", "~", "!" });
	public static List<String> PostfixOperators = Arrays.asList(new String[] {
			"++", "--" });
